...
//Saving the file as ListeRestaurantsEtoiles.json
function saveRestaurantsInJson() {
    return new Promise(function (resolve) {
        try {
            ...
            fs.writeFile("ListeRestaurantsEtoiles.json", jsonRestaurants, function doneWriting(err) {
...
module.exports.getRestaurantsJSON = function () {
    return JSON.parse(fs.readFileSync("ListeRestaurantsEtoiles.json"));
};